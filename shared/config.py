...
class Settings(BaseSettings):
    ...
    opensearch_endpoint: str = Field(default="http://localhost:9200", env="OPENSEARCH_ENDPOINT")
    ...
    # Observability
    otel_service_name: str = Field(default="insurance-platform", env="OTEL_SERVICE_NAME")
