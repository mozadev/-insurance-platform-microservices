...
def mock_dynamodb():
    ...
    with patch('services.policy_svc.app.repositories.dynamodb.get_dynamodb_client') as mock:
        mock_client = Mock()
...
def test_create_policy(client, mock_dynamodb, mock_sns):
    ...
    with patch('services.policy_svc.app.routers.policies.get_current_customer') as mock_auth:
